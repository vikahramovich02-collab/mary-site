...
// Маскот Mary. Анимация — кадры из ролика Вики: фон выбит по цвету, края мягкие,
// собрано в анимированный webp с прозрачностью. Прыжок из-за нижней кромки и
// возврат при скролле по-прежнему на CSS.
